...
public class ViewSinhVien extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbbTenPhong.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "P407", "P408", "P409" }));
        ...
        tblSinhVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tên phòng", "Điểm toán", "Điểm lý", "Điểm hóa", "Điểm Tb"
            }
        ));
    ...
    private void loadTable(List<SinhVien> listSinhVien) {
        ...
        for (SinhVien sinhVien : listSinhVien) {
            dtm.addRow(new Object[]{
                sinhVien.getId(), sinhVien.getPhong(), sinhVien.getDiemToan(),
